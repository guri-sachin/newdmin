...
<div class="row">
          <div class="col-md-4">
          <div class="da">
          <div class="da1">Total Users</div>
          <div class="da2" style={{text_align:"center"}}> {product.length}</div>
          </div>
          </div>
          <div class="col-md-4">
          <div class="da">
          <div class="da1">Total Orders</div>
          <div class="da2" style={{text_align:"center"}}>{product3.length}</div>
          </div>
          </div>
          <div class="col-md-4">
          <div class="da">
          <div class="da1">Total Number of Products</div>
          <div class="da2" style={{text_align:"center"}}>{product1.length}</div>
          </div>
          </div>
