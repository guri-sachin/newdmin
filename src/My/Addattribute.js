...

{
    ...
    function Saveproduct(e){
        ...
        var data ={"atnames":color};
      console.log(data);
         axios.post("http://localhost:4200/addatributs",data).then(
             res=> console.log(res)
           )
           Swal.fire({
            icon: 'success',
            ...
            text: "color added",
              ...
              function Shows(e){
                ...
                axios.get(`http://localhost:4200/deleteattri/${id}`).then(
            ...
            <div class="body d-flex py-3">
                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <h3 class="fw-bold mb-0">Add Attribute</h3>
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3 align-items-center">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" required onChange={handelDemo1}/>
                                            </div>
                                            <div class="col-md-12">
                ...
                <div class="container-xxl">
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <h3 class="fw-bold mb-0">Attribute List</h3>
