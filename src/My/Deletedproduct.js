...
function Admin()
{
    ...
    useEffect(()=>{
       axios.get("http://localhost:4200/listdeleted").then(res=>setProducts(res.data));
...
const handleSearch = (event) => {
  ...
  function Shows(e){
    ...
    axios.get(`http://localhost:4200/deldeleted/${id}`).then(
        res => console.log(res.data));
      
    
    axios.get(`http://localhost:4200/undodel/${id}`).then(
      res => setProducts1(res.data));
       
      Swal.fire({
        icon: 'success',
        // title: 'Password Changed',
        text: "Product Undo succesfully",
    })
                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <h3 class="fw-bold mb-0">Deleted Products</h3>
                     ...
                     <tr key={index}>
                            ...
                            <div class="card mb-3 bg-transparent p-2">
                                <div class="card border-0 mb-1">
                                    ...
                                    <Button class="danger" id={item.id} onClick ={Shows}>Undo</Button></div>
