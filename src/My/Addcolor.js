         ...
         axios.post("http://localhost:4200/caores",data).then(
           ...
           Swal.fire({
            ...
            text: "color added",
              ...
              useEffect(()=>{
                axios.get("http://localhost:4200/colores").then(res=>setProducts(res.data));
            ...
            function Shows(e){
                ...
                axios.get(`http://localhost:4200/deletecolor/${id}`).then(
            ...
            <div class="body d-flex py-3">
                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <h3 class="fw-bold mb-0">Add Color</h3>
                ...
                <div class="container-xxl">
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <h3 class="fw-bold mb-0">Color List</h3>
